...
def send_message(
    ...
    # Enhance tone, structure, and readability via JARVIS personality layer
    try:
        from core.message_formatter import format_as_jarvis_message
        message_text = format_as_jarvis_message(message_text, context=context)
    except Exception as e:
        print(f"[SendMessage] Formatter fallback: {e}")
